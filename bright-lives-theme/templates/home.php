	...
	<body <?php body_class(); ?>>
		...
		<main>
                ...
                <article class="container mx-auto grid grid-cols-1 md:grid-cols-2">
                    <div class="flex items-center">
                        <div class="font-sans-serif max-w-lg">
	                        ...
	                        <?php render_custom_button('Meer over onze missie', '#', true, true); ?>
                        </div>
                    </div>
                    <div class="pt-24">
            ...
            <section class="container mx-auto pt-24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4">
                    <article class="p-10 bg-primary-500">
                        <div class="h-28">
                            <h3 class="text-2xl font-heading text-white mb-4">Child Support Ghana (CSG)</h3>
                        </div>
                        <div class="h-48">
                            <p class="text-white">
                                Child Support Ghana helpt kwetsbare meisjes met onderwijs, gezondheidszorg,
                                een veilige leefomgeving en aandacht. Het vindt plaats in Wa, de hoofdstad van de
                                Upper West Region in Ghana.
                            </p>
                        </div>
	                    <?php render_custom_button('Ontdek hoe we dit doen', '#', false); ?>
                    </article>
                    <article class="p-10 bg-primary-600">
	                    ...
	                    <?php render_custom_button('Ontdek Wa Yiri Residence', '#', false); ?>
                    </article>
                    <article class="p-10 bg-primary-700">
	                    ...
	                    <?php render_custom_button('Ontdek hoe jij kunt helpen', '#', false); ?>
                    </article>
                    <article class="p-10 bg-primary-800">
	                    ...
	                    <?php render_custom_button('Ontdek onze begeleiding', '#', false); ?>
                    </article>
                </div>
            </section>
            ...
            <article class="container mx-auto py-24 grid grid-cols-1 md:grid-cols-2">
                ...
                <div>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="flex flex-col mb-5 pb-5 gap-4 border-b-2 border-primary-500">
                        ...
                        <div class="flex flex-col pb-5 gap-4 border-b-2 border-primary-500">
                            <div class="text-6xl font-black text-primary-500 leading-tight">
                                100
                            </div>
            ...
            <section class="container mx-auto mb-20 py-18 grid grid-cols-1 gap-10 md:grid-cols-3">
                <div class="h-80vh bg-center bg-cover bg-eten-tafel"></div>
                <div class="h-80vh bg-center bg-cover bg-jongens-stoep"></div>
                <div class="h-80vh bg-center bg-cover bg-klaslokaal"></div>
            </section>
